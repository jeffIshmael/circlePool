...
export declare namespace IHederaTokenService {
  ...
  export interface ExpiryHelperInterface extends Interface {
...
decodeFunctionResult(functionFragment: 'updateTokenInfo', data: BytesLike): Result;
  ...
  export interface ExpiryHelper extends BaseContract {
    
    connect(runner?: ContractRunner | null): ExpiryHelper;
    waitForDeployment(): Promise<this>;

    interface: ExpiryHelperInterface;
